package com.moumita.service.impl;
...
import com.moumita.beans.DemandBean;
import com.moumita.beans.ProductBean;
import com.moumita.service.ProductService;
import com.moumita.utility.DBUtil;
import com.moumita.utility.IDUtil;
import com.moumita.utility.MailMessage;
...
public class ProductServiceImpl implements ProductService {
	...
	public List<ProductBean> searchAllProducts(String search) {
		...
		try {
			ps = con.prepareStatement(
					"SELECT * FROM `shopping-cart`.product where lower(ptype) like ? or lower(pname) like ? or lower(pinfo) like ? order by pprice");
			search = "%" + search + "%";
