...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "moumitamca100@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Shop Easy</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Shop Easy.<br>"
					...
					+ "<span class='greenText'>SHOPEASY500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
