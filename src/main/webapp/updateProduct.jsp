			...
			<form action="./UpdateProductSrv" method="post"
				...
				<div class="row">
					<div class="col-md-6 text-center" style="margin-bottom: 2px;">
						<button formaction="adminViewProduct.jsp" class="btn btn-danger" style="width:100%; float: left;">Cancel</button>
					</div>
					<div class="col-md-6 text-center">
						<button type="submit" class="btn btn-success"  style="width:100%; float: right;">Update
							Product</button>
					</div>
				</div>
			</form>
