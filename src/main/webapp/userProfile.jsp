...
<body style="background-color: #E6F9E6;">
	...
	if (user == null)
		user = new UserBean("Test User", 11234567890L, "moumitamca100@gmail.com", "ABC colony, Kolkata, West Bengal", 87659, "lksdjf");
	%>
	...
	<div class="container bg-secondary" style="font-family: 'Lora', serif;">
		<div class="row">
			<div class="col">
