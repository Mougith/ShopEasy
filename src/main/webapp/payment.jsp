	...
	<div class="container">
		<div class="row"
			...
			<form action="./OrderServlet" method="post"
				...
				style="border: 2px solid black; border-radius: 10px; background-color: #FEBD6A; padding: 10px; padding: 50px 35px; font-family: 'Lora', serif; border-radius: 10px; backdrop-filter: blur(10px); border: 2px solid rgba(255,255,255,0.1); box-shadow: 0 0 40px rgba(8,7,16,0.6);">
				...
				<div class="row">
					...
					<div class="col-md-4 form-group">
						<label for="last_name">Enter CVV</label> <input type="number"
							placeholder="123" class="form-control" size="4" id="last_name"
							name="expyear" required> 
						<%
							double price = amount;
	    				...
	    				%>
						<input type="hidden"
							name="amount" value="<%=priceFormatter.format(price)%>">
				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						<a href="<%=session.getAttribute("prevURL") %>" class="btn btn-danger" style="color: white; width:100%; margin-top:10px;">Cancel</a>
					</div>
					<div class="col-md-6 form-group">
						<button type="submit" class="form-control btn btn-success">
							Pay: Rs.
							<%=priceFormatter.format(price)%></button>
					</div>
				</div>
			</form>
		</div>
