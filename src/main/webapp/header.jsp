...
<%@ page import="com.moumita.service.impl.*,com.moumita.service.*"%>
...
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com">
<link href="https://fonts.googleapis.com/css2?family=Lora:ital,wght@0,400;0,500;0,600;0,700;1,400;1,600;1,700&family=Oswald:wght@300;400;500;600;700&family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
<script
...
<body>
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-image: url('images/banner.jpg'); background-size:cover; background-color: #33cc33; color: white; padding: 5px;">
		<h2 style="font-family: 'Lora', serif; text-shadow: 3px 3px 3px #ababab;">Shop Easy</h2>
		<h6 style="font-family: 'Poppins', sans-serif;">Your one stop shop for online shopping</h6>
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a style="letter-spacing: normal; font-family: 'Oswald', sans-serif;" class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home"></span>&nbsp;Shopping Center</a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul style="letter-spacing: normal; font-family: 'Oswald', sans-serif;" class="nav navbar-nav navbar-right">
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="userHome.jsp"><span
					class="glyphicon glyphicon-home" style="color:#ffc835"></span>&nbsp;Shopping Center</a>
			</div>

			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right" style="letter-spacing: normal; font-family: 'Oswald', sans-serif;">
					<li><a href="userHome.jsp"><span
					class="glyphicon glyphicon-home" style="color:#ffc835"></span>&nbsp;Products</a></li>
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#">Category <span class="caret"></span>
					</a>
						<ul class="dropdown-menu">
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="adminViewProduct.jsp"><span
					class="glyphicon glyphicon-home" style="color:#04f567"></span>&nbsp;Shopping Center</a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					<li><a href="adminViewProduct.jsp"><span
					class="glyphicon glyphicon-home" style="color:#04f567"></span>&nbsp;Products</a></li>
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#">Category <span class="caret"></span>
					</a>
						<ul class="dropdown-menu">
